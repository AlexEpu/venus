...
'imdbRating': '',},
  ...
  handleOnChange = (event) => {
    fetch(
      `https://ancient-caverns-16784.herokuapp.com/movies?take=10&Title=`+event.target.value
    )
  ...
  render() { 
    ...
    return(
      <div>
        <input placeholder="Search.." className="searchinput" type="text" value={this.state.input} SearchFilter={this.handleOnSearchChange} updateValue={this.handleSearch} onChange={this.handleOnChange}  />
        <Country handleCountryChange={this.handleCountryChange} Country={this.state.Country} />
